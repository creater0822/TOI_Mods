...
{
    public class UIDesignateHeartTechnique : MonoBehaviour
    {
        ...
        public DataStruct<string, DataProps.MartialData>[] allItems
        {
            get
            {
                ...
                list.Add(new DataStruct<string, DataProps.MartialData>("last", (ModMain.lastStudyAbility != null) ? ModMain.lastStudyAbility.t2.data.To<DataProps.MartialData>() : null));
                ...
                while (enumerator.MoveNext())
                {
                    ...
                    DataProps.MartialData martialData = current.value.data.To<DataProps.MartialData>();
                    if (martialData.martialType == MartialType.Ability)
                    {
                        list.Add(new DataStruct<string, DataProps.MartialData>(current.value.data.soleID, martialData));
                    }
                }
                return list.ToArray();
            }
        ...
        public UIDesignateHeartTechnique(System.IntPtr ptr)
            : base(ptr)
        {
        }
        ...
        private void Awake()
        {
            ...
            textTitle.text = "Choose your mind";
            leftTitle.text = "You can choose from the following methods";
            rightTitle.text = "The chosen mentality";
        }
        ...
        public void OnBtnOk()
        {
            if (selectItem == null)
            {
                UITipItem.AddTip("Please choose your mind first!", 0f);
                return;
            }
            string arg = "";
            if (selectItem.t1 == "last")
