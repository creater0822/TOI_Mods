    ...
    public class UIChooseRule : MonoBehaviour
    {
        ...
        public DataStruct<string, DataProps.PropsData>[] allItems
        {
            get
            {
                ...
                DataStruct<string, DataProps.PropsData> item = new DataStruct<string, DataProps.PropsData>("last", (ModMain.lastAddRule != null) ? ModMain.lastAddRule.t2 : null);
                list.Add(item);
        ...
        public UIChooseRule(System.IntPtr ptr)
            : base(ptr)
        {
        }
        ...
        private void Awake()
        {
            ...
            textTitle.text = "Choose Daoist soul";
            leftTitle.text = "Chooise Taoist Soul below..";
        ...
        public void InitData(UIDaguiToolItem toolItem, int index, WorldUnitBase unit)
        {
            ...
            foreach (DataStruct<string, DataProps.PropsData> dataStruct in array)
            {
                ...
                {
                    text = "The last Taoist soul added:";
                }
        ...
        public void AddTip(GameObject go, DataStruct<string, DataProps.PropsData> data)
        {
            ...
            uIEventListener.onMouseEnterCall += (Il2CppSystem.Action)(System.Action)delegate
            {
                ...
                if (propsData == null)
                {
                    propsData = DataProps.PropsData.NewProps(5082066, 1);
                }
        ...
        public void OnBtnOk()
        {
            if (selectItem == null)
            {
                UITipItem.AddTip("Please choose Daohun first!", 0f);
                return;
            }
            string arg = "";
            if (selectItem.t1 == "last")
            {
                arg = "Taoist soul added last time";
            }
