...
namespace MOD_bgToolbox.Item
{
    public class UIDesignateSect : MonoBehaviour
    {
        ...
        public MapBuildSchool[] allItems => g.world.build.GetBuilds<MapBuildSchool>().ToArray();

        public UIDesignateSect(IntPtr ptr)
            : base(ptr)
        {
        }
        ...
        private void Awake()
        {
            ...
            textTitle.text = "Choose a sect";
            leftTitle.text = "Choose a sect below";
            rightTitle.text = "Selected sect";
        }

        public void InitData(UIDaguiToolItem toolItem, int index)
        {
            MapBuildSchool[] array = allItems;
            foreach (MapBuildSchool mapBuildSchool in array)
            {
                MapBuildSchool selectItem = mapBuildSchool;
                string text = GameTool.LS(mapBuildSchool.name);
            ...
            obj2.GetComponentInChildren<Text>().text = "All sects";
        ...
        public void OnBtnOk()
        {
            if (selectItem == null)
            {
                UITipItem.AddTip("Please choose your sect first!", 0f);
                return;
            }
