...
namespace MOD_bgToolbox.Item
{
    public class UIChooseFairyTechnique : MonoBehaviour
    {
        ...
        public ConfImmortalHumanItem[] allItems => g.conf.immortalHuman._allConfList.ToArray();

        public UIChooseFairyTechnique(IntPtr ptr)
            : base(ptr)
        {
        }
        ...
        private void Awake()
        {
            ...
            textTitle.text = "Choose Heavenly Art";
            leftTitle.text = "Choose Heavenly Art to obtain below..";
            rightTitle.text = "The chosen immortal";
        }

        public void InitData(UIDaguiToolItem toolItem, int index)
        {
            ConfImmortalHumanItem[] array = allItems;
            foreach (ConfImmortalHumanItem confImmortalHumanItem in array)
            {
                ConfImmortalHumanItem selectItem = confImmortalHumanItem;
                string text = GameTool.LS(confImmortalHumanItem.name);
        ...
        public void OnBtnOk()
        {
            if (selectItem == null)
            {
                UITipItem.AddTip("Please choose the immortal first!", 0f);
                return;
            }
