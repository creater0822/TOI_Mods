...
namespace MOD_bgToolbox.Item
{
    public class UIPosition : MonoBehaviour
    {
        ...
        public static DataStruct<string, string>[] allAttr = new DataStruct<string, string>[6]
        {
            new DataStruct<string, string>("1", "Leader"),
            new DataStruct<string, string>("2", "Grand Elder"),
            new DataStruct<string, string>("3", "Elder"),
            new DataStruct<string, string>("4", "True Disciple"),
            new DataStruct<string, string>("5", "Inner Disciple"),
            new DataStruct<string, string>("6", "Outer Disciple")
        };
        ...
        private void Awake()
        {
            ...
            leftTitle.text = "Choose a position below";
